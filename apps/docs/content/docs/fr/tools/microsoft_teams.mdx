...
Intégrez les fonctionnalités de Microsoft Teams pour gérer les messages. Lisez le contenu des messages existants et écrivez des messages en utilisant l'authentification OAuth. Prend en charge la manipulation de contenu textuel pour la création et l'édition de messages.
