...
### How do I scrape content from a website using the Firecrawl block in my workflow?
...
### What outputs can I reference from a Firecrawl scraping operation?
...
### How do I search the web for information using Firecrawl instead of scraping specific URLs?
...
### How do I connect a Firecrawl block to an Agent block for content analysis?
...
### What is the difference between scraping, searching, and crawling operations in Firecrawl?
...
### How do I crawl an entire website and process all pages with Firecrawl?
...
### Why is my Firecrawl operation failing or returning empty results?
...
### Can I combine Firecrawl with other blocks for automated web monitoring?
