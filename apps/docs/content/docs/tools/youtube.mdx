...
<Accordions type="single">
  <Accordion title="How do I search for YouTube videos in my workflow?">
  ...
  <Accordion title="How do I get a YouTube API key for the YouTube block?">
  ...
  <Accordion title="What outputs does the YouTube block provide and how do I reference them?">
  ...
  <Accordion title="How do I connect YouTube search results to an Agent block for content analysis?">
  ...
  <Accordion title="How do I filter YouTube search results based on specific criteria?">
  ...
  <Accordion title="Why is my YouTube search returning no results or errors?">
  ...
  <Accordion title="Can I use YouTube search results to create automated video recommendations?">
  ...
  <Accordion title="How do I handle large YouTube search results efficiently in my workflow?">
