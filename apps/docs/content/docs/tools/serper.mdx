...
<Accordions type="single">
  <Accordion title="How do I add web search capabilities to my Sim.ai workflow using Serper?">
  ...
  <Accordion title="What outputs does the Serper block provide and how do I reference them?">
  ...
  <Accordion title="How do I create a workflow that searches the web based on user input?">
  ...
  <Accordion title="How do I get a Serper API key and configure authentication?">
  ...
  <Accordion title="What search types does Serper support and how do I use them?">
  ...
  <Accordion title="How do I combine Serper with Agent blocks for intelligent search responses?">
  ...
  <Accordion title="Why am I getting empty or irrelevant search results from Serper?">
