...
### How do I add web search capabilities to my Sim.ai workflow using Linkup?
...
### What's the difference between "standard" and "deep" search depth in Linkup?
...
### How do I reference Linkup search results in downstream blocks?
...
### How do I connect an Agent block to search the web with Linkup?
...
### Should I use "sourcedAnswer" or "searchResults" for my outputType?
...
### Why is my Linkup search returning empty results?
...
### How do I create a workflow that searches for information and provides sourced answers?
...
### How do I access individual sources from Linkup search results?
