...
### How do I search for relevant content in my knowledge base using a workflow?

To search your knowledge base in Sim.ai workflows, add a **Knowledge block** and configure the search operation:
...
### How do I reference Knowledge block search results in other parts of my workflow?
...
### What is the correct way to connect Knowledge search results to an Agent block for contextual responses?

To provide search results as context to an AI agent:

1. **Configure Knowledge Search** with user's question: `<start.userQuery>`
2. **Connect Results to Agent** in the context or system prompt field
3. **Structure the Prompt** to utilize the retrieved information
...
### How do I upload new content chunks to existing documents in my knowledge base?
...
### How do I create new documents with tags in my knowledge base programmatically?
...
### Why is my Knowledge block returning empty results or failing to find relevant content?
...
### Can I combine multiple Knowledge blocks to search across different knowledge bases?
