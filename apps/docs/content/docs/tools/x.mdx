...
<Accordions type="single">
  <Accordion title="How do I post a tweet from my Sim.ai workflow using the X block?">
  ...
  <Accordion title="How do I search for tweets about specific topics using the X search operation?">
  ...
  <Accordion title="What outputs can I reference from the X block in downstream workflow blocks?">
  ...
  <Accordion title="How do I create a workflow that monitors X mentions and responds automatically?">
  ...
  <Accordion title="Why is my X block failing to authenticate or post content?">
  ...
  <Accordion title="How do I analyze X user profiles and their recent activity?">
  ...
  <Accordion title="Can I combine the X block with Agent blocks for intelligent social media automation?">
