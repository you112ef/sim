...
<Accordions type="single">
  <Accordion title="How do I connect Microsoft Planner to read tasks from a specific plan in my workflow?">
  ...
  <Accordion title="What connection tags can I use to reference Microsoft Planner block outputs in downstream blocks?">
  ...
  <Accordion title="How do I create a new task in Microsoft Planner with data from other blocks?">
  ...
  <Accordion title="How do I authenticate Microsoft Planner with my Sim.ai workflow?">
  ...
  <Accordion title="Can I combine Microsoft Planner with Agent blocks to create AI-generated tasks?">
  ...
  <Accordion title="Why am I getting authentication errors when using Microsoft Planner?">
  ...
  <Accordion title="How do I handle task creation errors and implement retry logic?">
