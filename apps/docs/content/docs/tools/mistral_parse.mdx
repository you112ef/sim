...
<Accordions type="single">
  <Accordion title="How do I extract text from a PDF document using the Mistral Parser block in my workflow?">
  ...
  <Accordion title="What is the correct way to reference Mistral Parser outputs in downstream blocks?">
  ...
  <Accordion title="How do I upload a PDF file directly instead of using a URL?">
  ...
  <Accordion title="How do I combine Mistral Parser with Agent blocks for document analysis?">
  ...
  <Accordion title="What PDF URL formats are supported and which ones should I avoid?">
  ...
  <Accordion title="Why is my Mistral Parser block failing to process PDFs?">
  ...
  <Accordion title="Can I process only specific pages from a large PDF document?">
