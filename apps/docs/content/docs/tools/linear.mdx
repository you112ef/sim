...
<Accordions type="single">
  <Accordion title="How do I fetch issues from my Linear team in a workflow?">
  ...
  <Accordion title="How do I create a new issue in Linear from my workflow?">
  ...
  <Accordion title="What outputs can I reference from Linear blocks in my workflow?">
  ...
  <Accordion title="How do I connect an Agent block to automatically create Linear issues?">
  ...
  <Accordion title="Why am I getting authentication errors with the Linear block?">
  ...
  <Accordion title="How do I filter and process Linear issues in my workflow?">
  ...
  <Accordion title="Can I create Linear issues conditionally based on workflow data?">
