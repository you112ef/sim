...
### How do I set up a Stagehand Agent to browse a website and extract data?
...
### How do I reference the results from a Stagehand Agent in downstream blocks?
...
### What is the correct way to write tasks for the Stagehand Agent?
...
### How do I connect a Webhook trigger to a Stagehand Agent for automated web browsing?
...
### Why is my Stagehand Agent failing or returning incomplete results?
...
### How do I structure the output schema for consistent data extraction?
...
### What are common workflow patterns that combine Stagehand Agent with other blocks?
