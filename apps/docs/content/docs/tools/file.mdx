...
<Accordions type="single">
  <Accordion title="How do I upload files to my workflow using the File block?">
  ...
  <Accordion title="How do I reference parsed file content in downstream blocks?">
  ...
  <Accordion title="How do I connect file content to an Agent block for processing?">
  ...
  <Accordion title="Can I process different file types simultaneously with the File block?">
  ...
  <Accordion title="Why is my file not being parsed correctly?">
  ...
  <Accordion title="How do I create a document analysis workflow using the File block?">
  ...
  <Accordion title="How do I handle multiple file uploads and process them individually?">
