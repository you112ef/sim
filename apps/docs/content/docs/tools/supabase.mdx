...
<Accordions type="single">
  <Accordion title="How do I query data from my Supabase database in a workflow?">
  ...
  <Accordion title="How do I insert new records into my Supabase table from a workflow?">
  ...
  <Accordion title="What is the correct way to reference Supabase block outputs in my workflow?">
  ...
  <Accordion title="How do I update existing records in my Supabase database?">
  ...
  <Accordion title="How do I handle authentication and connect to my Supabase project?">
  ...
  <Accordion title="Why is my Supabase query returning empty results or failing?">
  ...
  <Accordion title="How do I integrate Supabase with Agent blocks for dynamic database operations?">
