...
<Accordions type="single">
  <Accordion title="How do I search the web using the Tavily block in my workflow?">
  ...
  <Accordion title="How do I extract content from specific websites using Tavily?">
  ...
  <Accordion title="What outputs can I reference from a Tavily block in downstream workflow steps?">
  ...
  <Accordion title="How do I connect Tavily search results to an Agent block for analysis?">
  ...
  <Accordion title="Why is my Tavily search returning no results or failing?">
  ...
  <Accordion title="Can I create automated research workflows combining Tavily with other blocks?">
  ...
  <Accordion title="How do I handle multiple URLs for content extraction in a single Tavily block?">
