...
<Accordions type="single">
  <Accordion title="How do I generate images from my workflow using the Image Generator block?">
  ...
  <Accordion title="How do I connect an Agent block's output to the Image Generator prompt?">
  ...
  <Accordion title="What outputs can I reference from the Image Generator block in my workflow?">
  ...
  <Accordion title="How do I set up authentication for the Image Generator block?">
  ...
  <Accordion title="Can I generate multiple images with different prompts in one workflow?">
  ...
  <Accordion title="Why is my Image Generator block failing to create images?">
  ...
  <Accordion title="How do I integrate Image Generator with other blocks for automated workflows?">
