...
<Accordions type="single">
  <Accordion title="How do I generate embeddings from text in my Sim.ai workflow?">
  ...
  <Accordion title="What outputs can I reference from an Embeddings block in my workflow?">
  ...
  <Accordion title="How do I connect text from other blocks to generate embeddings?">
  ...
  <Accordion title="How do I use embeddings with vector databases or similarity calculations?">
  ...
  <Accordion title="Why are my embeddings not generating properly?">
  ...
  <Accordion title="How do I process multiple texts for batch embedding generation?">
  ...
  <Accordion title="Can I use different OpenAI embedding models in my workflow?">
