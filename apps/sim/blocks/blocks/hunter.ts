import { HunterIO } from '@/components/icons'
import type { BlockConfig } from '@/blocks/types'
import type {  } from '@/tools/youtube/types'

export const HunterBlock: BlockConfig<YouTubeSearchResponse> = {
  type: 'youtube',
  name: 'YouTube',
  ...
  docsLink: 'https://docs.simstudio.ai/tools/youtube',
  category: 'tools',
  bgColor: '#FF0000',
  icon: YouTubeIcon,
  subBlocks: [
