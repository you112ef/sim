              ...
              <div className='flex justify-between'>
                ...
                {userPermissions.canEdit && (
                  <Button
                    ...
                    className='bg-brand-primary font-[480] text-muted-foreground shadow-[0_0_0_0_var(--brand-primary-hex)] transition-all duration-200 hover:bg-brand-primary-hover hover:shadow-[0_0_0_4px_rgba(127,47,255,0.15)]'
                  >
                    {isSaving ? (
                      <>
