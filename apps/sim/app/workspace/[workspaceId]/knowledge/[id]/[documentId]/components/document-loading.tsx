            ...
            <div className='px-6 pb-6'>
              ...
              <div className='mb-4 flex items-center justify-between pt-1'>
                ...
                <Button
                  disabled
                  size='sm'
                  className='flex items-center gap-1 bg-brand-primary font-[480] text-muted-foreground shadow-[0_0_0_0_var(--brand-primary-hex)] transition-all duration-200 hover:bg-brand-primary-hover hover:shadow-[0_0_0_4px_rgba(127,47,255,0.15)] disabled:opacity-50'
                >
