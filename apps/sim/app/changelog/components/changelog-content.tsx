    ...
    <div className='min-h-screen bg-background'>
      <div className='relative grid md:grid-cols-2'>
        ...
        <div className='relative top-0 overflow-hidden border-border border-b px-6 py-16 sm:px-10 md:sticky md:h-dvh md:border-r md:border-b-0 md:px-12 md:py-24'>
          ...
          <div className='absolute inset-0 bg-linear-to-tr from-background via-transparent to-background/60' />
          ...
          <div className='relative mx-auto h-full max-w-xl md:flex md:flex-col md:justify-center'>
            ...
            <div className='mt-6 flex flex-wrap items-center gap-3 text-sm'>
              <Link
                ...
                className='group inline-flex items-center justify-center gap-2 rounded-[10px] border border-[#6F3DFA] bg-linear-to-b from-[#8357FF] to-[#6F3DFA] py-[6px] pr-[10px] pl-[12px] text-[14px] text-white shadow-[inset_0_2px_4px_0_#9B77FF] transition-all sm:text-[16px]'
              >
